...
myConn <-odbcDriverConnect("Driver=Teradata Database ODBC Driver 16.10;DBCName=teradata-data.fyiblue.com;Uid=app_aim;Pwd=blue7829;")

#data <- sqlFetch(myConn,"ca_het.temp_SDoH_2017_dta")
```

```{r}
# Import the file to R
#dta <- read.csv("G:/CCONSULT/3 IL HET/2_Boeing/Strategy Meetings/201902_SDoH/2.Analyze/Personal #Folders/Joan/dfx.csv",header = TRUE,sep=",",colClasses=c("character","character"))


dta <- read.csv("G:/CCONSULT/3 IL HET/2_Boeing/Strategy Meetings/201902_SDoH/2.Analyze/Personal Folders/Joan/df4.csv",header = TRUE,sep=",",colClasses=c("character","character"))

```

```{r}
dataPath <- "G:/CCONSULT/3 IL HET/2_Boeing/Strategy Meetings/201902_SDoH/2.Analyze/Personal Folders/Joan"
```
...
```{r}
sqlSave(myConn,sdoh_pc_1,tablename="CA_HET.temp_sdoh_pcs_clusters",append = TRUE, rownames = FALSE, colnames=FALSE,verbose = TRUE,safer=TRUE)
```
